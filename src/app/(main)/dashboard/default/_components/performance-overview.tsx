...
export function PerformanceOverview() {
  ...
  return (
    <Card className="@container/card">
      <CardHeader className="@[560px]/card:has-data-[slot=card-action]:grid-cols-[1fr_auto]! has-data-[slot=card-action]:grid-cols-1!">
        ...
        <CardAction className="justify-self-stretch! @[560px]/card:justify-self-end! @[560px]/card:col-start-2! col-start-1! @[560px]/card:row-span-2! row-span-auto! @[560px]/card:row-start-1! row-start-auto! flex flex-wrap items-center @[560px]/card:justify-end gap-2">
            ...
            <ChartTooltip
              ...
              content={
                <ChartTooltipContent
                  className="w-50"
                  indicator="line"
                  labelFormatter={(value) => format(parseISO(String(value)), "d MMMM yyyy", { locale: dateFnsLocale })}
                />
              }
            />
